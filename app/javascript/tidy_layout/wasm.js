...
/**
*/
export const WasmLayoutType = Object.freeze({ Basic:0,"0":"Basic",Tidy:1,"1":"Tidy",LayeredTidy:2,"2":"LayeredTidy", });
/**
*/
export class Tidy {
    ...
    */
    change_layout(layout_type) {
        wasm.tidy_change_layout(this.ptr, layout_type);
    }
    /**
    * @param {number} id
    */
    remove_node(id) {
        wasm.tidy_remove_node(this.ptr, id);
    }
    /**
    * @returns {boolean}
    */
    is_empty() {
        const ret = wasm.tidy_is_empty(this.ptr);
        return ret !== 0;
    }
    /**
    * @param {number} id
    ...
    */
    add_node(id, width, height, parent_id) {
        wasm.tidy_add_node(this.ptr, id, width, height, parent_id);
    }
    /**
    ...
    */
    data(id, width, height, parent_id) {
        ...
        wasm.tidy_data(this.ptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
    }
    /**
    */
    layout() {
        wasm.tidy_layout(this.ptr);
    }
    /**
    ...
    */
    get_pos() {
        try {
            ...
            wasm.tidy_get_pos(retptr, this.ptr);
